 ...
 * @return  int
 */
function update_pay_log($id, $amount, $type = PAY_SURPLUS, $is_paid = 0)
{
    $sql = 'UPDATE ' .$GLOBALS['ecs']->table('pay_log')." set order_id=$id , order_amount='$amount', order_type='$type', is_paid='$is_paid'";
    $GLOBALS['db']->query($sql);
