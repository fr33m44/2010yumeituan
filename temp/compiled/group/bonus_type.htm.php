...
?>
    <tr>
      <td align="center"><span onclick="listTable.edit(this, 'edit_type_name', <?php echo $this->_var['type']['type_id']; ?>)"><?php echo htmlspecialchars($this->_var['type']['type_name']); ?></span></td>
