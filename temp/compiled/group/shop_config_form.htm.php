...
?>
            ...
            <table>
              ...
              <?php elseif ($this->_var['var']['code'] == "group_shipping"): ?>
                 <select name="value[<?php echo $this->_var['var']['id']; ?>]">
                 <?php $_from = $this->_var['shipping_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'shipping');if (count($_from)):
    foreach ($_from AS $this->_var['shipping']):
?>
                  <option value="<?php echo $this->_var['shipping']['shipping_id']; ?>" <?php if ($this->_var['shipping']['shipping_id'] == $this->_var['cfg']['group_shipping']): ?>selected<?php endif; ?>><?php echo $this->_var['shipping']['shipping_name']; ?></option>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                  </select>
            <?php endif; ?>
          <?php endif; ?>
