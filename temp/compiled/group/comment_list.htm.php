...
?>
  <tr>
    <td width="65"><input value="<?php echo $this->_var['comment']['comment_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $this->_var['comment']['comment_id']; ?></td>
    <td width="100"><?php if ($this->_var['comment']['user_name']): ?><?php echo $this->_var['comment']['user_name']; ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?></td>
    <td width="100"><a href="../index.php?id=<?php echo $this->_var['comment']['id_value']; ?>" target="_blank"><?php echo sub_str($this->_var['comment']['title'],30); ?></td>
    <td><?php echo $this->_var['comment']['content']; ?></td>
    <td><?php echo $this->_var['comment']['reply_content']; ?></td>
    <td align="center" width="120"><?php echo $this->_var['comment']['add_time']; ?></td>
    <td align="center" width="40" style="color:#3A6EA5;"><?php echo $this->_var['comment']['is_reply']; ?></td>
    <td align="center" width="28"><?php if ($this->_var['comment']['status'] == 0): ?><?php echo $this->_var['lang']['hidden']; ?><?php else: ?><?php echo $this->_var['lang']['display']; ?><?php endif; ?></td>
    <td align="center" width="50">
      <a href="comment_manage.php?act=reply&amp;id=<?php echo $this->_var['comment']['comment_id']; ?>"><?php echo $this->_var['lang']['view_content']; ?></a><br />
