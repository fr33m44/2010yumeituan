...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <th colspan="6" scope="col"><?php echo $this->_var['lang']['goods_info']; ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=goods" class="special"><?php echo $this->_var['lang']['edit']; ?></a></th>
...
?>
  ...
  <tr>
    ...
    <a href="../index.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?> <?php if ($this->_var['goods']['brand_name']): ?>[ <?php echo $this->_var['goods']['brand_name']; ?> ]<?php endif; ?>
  ...
  <tr>
    ...
    <td colspan="5"><?php if ($this->_var['operable_list']['confirm']): ?>
      ...
      <input name="confirm" type="submit" value="<?php echo $this->_var['lang']['op_confirm']; ?>" class="button" />
        ...
        <?php endif; ?>
         <?php if ($this->_var['operable_list']['send_card']): ?>

        <input name="send_card" type="submit" value="<?php echo $this->_var['lang']['op_card']; ?>" class="button" />
