...
?>
  <tr>
    ...
    <td align="center" nowrap="true"><span>
      <a href="../help.php?id=<?php echo $this->_var['list']['article_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="images/icon_view.gif" border="0" height="16" width="16" /></a>&nbsp;
