...
<div class="form-div">
  ...
  <form action="javascript:searchOrder()" name="searchForm">
    ...
    <!--<?php $_from = $this->_var['status_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'status');if (count($_from)):
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <th align="left"><a href="javascript:listTable.sort('add_time', 'DESC'); "><?php echo $this->_var['lang']['order_time']; ?></a><?php echo $this->_var['sort_order_time']; ?></th>

    <th align="left"><a href="javascript:listTable.sort('consignee', 'DESC'); "><?php echo $this->_var['lang']['consignee']; ?></a><?php echo $this->_var['sort_consignee']; ?></th>
...
?>
  ...
  <tr>
    ...
    <td valign="top" nowrap="nowrap" width="115"><input type="checkbox" name="checkboxes" value="<?php echo $this->_var['order']['order_sn']; ?>" /><a href="order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>" id="order_<?php echo $this->_var['okey']; ?>"><?php echo $this->_var['order']['order_sn']; ?><?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><div align="right"><?php echo $this->_var['lang']['group_buy']; ?></div><?php elseif ($this->_var['order']['extension_code'] == "exchange_goods"): ?><div align="right"><?php echo $this->_var['lang']['exchange_goods']; ?></div><?php endif; ?></a></td>

    <td width="100"><?php echo htmlspecialchars($this->_var['order']['buyer']); ?><br /><?php echo $this->_var['order']['short_order_time']; ?></td>
    ...
    <td align="center" nowrap="nowrap" width="50"><?php echo $this->_var['order']['formated_total_fee']; ?></td>

    <td align="center" nowrap="nowrap" width="50"><?php echo $this->_var['order']['formated_order_amount']; ?></td>

    <td align="center" nowrap="nowrap" width="120" style="color:#3A6EA5;"><?php echo $this->_var['lang']['os'][$this->_var['order']['order_status']]; ?>,<?php echo $this->_var['lang']['ps'][$this->_var['order']['pay_status']]; ?>,<?php echo $this->_var['lang']['ss'][$this->_var['order']['shipping_status']]; ?></td>
