...
$_LANG['remove_sql'] = '您还没有删除 sql 文件夹，出于安全的考虑，我们建议您删除 sql 文件夹。';

$_LANG['remove_installphp'] = '您还没有删除 install.php 文件，出于安全的考虑，我们建议您删除 install.php 文件。';
