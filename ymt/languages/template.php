...
$_LANG['template_libs']['group_header'] = '页面顶部';
$_LANG['template_libs']['group_footer'] = '页面尾部';
$_LANG['template_libs']['group_pages'] = '列表分页';
$_LANG['template_libs']['group_gonggao'] = '团购公告';
$_LANG['template_libs']['group_ing'] = '右侧团购';
$_LANG['template_libs']['group_member_info'] = '会员信息';
$_LANG['template_libs']['group_order_total'] = '订单费用总计';
$_LANG['template_libs']['group_share'] = '团购分享';
$_LANG['template_libs']['group_status'] = '团购状态';
$_LANG['template_libs']['group_user_menu'] = '登录状态';
$_LANG['template_libs']['group_vote'] = '在线调查';
