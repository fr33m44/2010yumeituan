...
if ($_REQUEST['act'] == 'list')
{
    ...
    /* 获得所有邮件模板 */
    $sql = "SELECT template_id, template_code FROM " .$ecs->table('mail_templates') . " WHERE  type = 'sms'";
    $res = $db->query($sql);
    $cur = null;
    ...
    $smarty->display('sms_template.htm');
}
...
elseif ($_REQUEST['act'] == 'loat_template')
{
    ...
    make_json_result($smarty->fetch('sms_template.htm'));
}
