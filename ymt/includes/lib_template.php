...
function get_template_info($template_name, $template_style='')
{
    ...
    if ($template_style == '')
    {
        foreach ($ext AS $val)
        {
            if (file_exists('../template/' . $template_name . "/images/screenshot.$val"))
            {
                $info['screenshot'] = '../template/' . $template_name . "/images/screenshot.$val";
    ...
    else
    {
        foreach ($ext AS $val)
        {
            if (file_exists('../template/' . $template_name . "/template/screenshot_$template_style.$val"))
            {
                $info['screenshot'] = '../template/' . $template_name . "/images/screenshot_$template_style.$val";
    ...
    $css_path = '../template/' . $template_name . '/style.css';
    if ($template_style != '')
    {
        $css_path = '../template/' . $template_name . "/style_$template_style.css";
    }
...
function get_template_region($tmp_name, $tmp_file, $lib=true)
{
    ...
    $file = '../template/' . $tmp_name . '/' . $tmp_file;
...
function move_plugin_library($tmp_name, &$msg)
{
    ...
    $return_value = true;
    $target_dir = ROOT_PATH . 'template/' . $tmp_name;
    $source_dir = ROOT_PATH . 'template/' . $GLOBALS['_CFG']['template'];
...
function get_editable_libs($curr_template, $curr_page_libs)
{
    ...
    if ($xml_content = @file_get_contents(ROOT_PATH . 'template/' . $_CFG['template'] . '/libs.xml'))
    {
